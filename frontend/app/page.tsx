...
import { Type, Split, FileArchive, RefreshCw, FileText, FileSpreadsheet, ScanText, Lock, Unlock, Stamp, Crown, ShieldCheck, FileCheck2, ImageDown } from 'lucide-react';
...
export default function Dashboard() {
    const tools = [
        ...
        { name: "PDF para Imagem", desc: "Converta cada página do PDF em PNG ou JPG de alta resolução (300 DPI). Múltiplas páginas geram um ZIP.", icon: <ImageDown className="w-8 h-8 text-gray-400 group-hover:text-[#2980f2] transition-colors duration-500" />, href: "/pdf-to-image", premium: false },
