    ...
    return (
        <div className="min-h-screen bg-transparent dark:bg-transparent flex flex-col pt-24 pb-12 px-4 items-center font-sans tracking-tight transition-colors">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#33333B] dark:text-gray-100 mb-3 flex items-center gap-3">
                <Unlock className="w-10 h-10 text-[#2980f2]" /> Desbloquear PDF
            </h1>
            ...
            {!file ? (
                ...
                <div className="bg-white dark:bg-[#1e1e1e] p-10 rounded-[30px] shadow-2xl border border-gray-100 dark:border-gray-800 flex flex-col items-center w-full max-w-xl animate-in fade-in zoom-in-95">
                    <div className="w-16 h-16 bg-[#2980f2]/5 dark:bg-[#2980f2]/10 rounded-full flex items-center justify-center mb-4">
                        <Unlock className="w-8 h-8 text-[#2980f2]" />
                    </div>
                    ...
                    {errorMsg && (
                        <div className="w-full bg-[#2980f2]/5 dark:bg-[#2980f2]/10 text-[#2980f2] dark:text-gray-500 p-4 border border-[#2980f2]/50 dark:border-red-800 rounded-xl mb-6 flex flex-col items-center gap-2 font-medium">
                    ...
                    <div className="w-full space-y-5">
                        <div className="relative">
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    className="w-full py-4 px-5 pr-12 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#121212] text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#2980f2] transition-shadow"
                                />
                        ...
                        <button onClick={handleProcess} className="w-full min-w-[300px] flex items-center justify-center gap-2 bg-[#2980f2] hover:bg-[#2980f2]/90 text-white font-bold py-4 rounded-xl shadow-lg transition-transform transform hover:-translate-y-1 mt-6">
                ...
                <div className="flex flex-col items-center mt-20 animate-in zoom-in">
                    <Loader2 className="w-20 h-20 animate-spin text-[#2980f2] mb-8" />
                ...
                <div className="flex flex-col items-center mt-10 p-12 bg-white dark:bg-[#1e1e1e] rounded-[40px] shadow-2xl border animate-in slide-in-from-bottom-5">
                    <CheckCircle className="w-24 h-24 text-[#2980f2] mb-6 drop-shadow-md" />
                    ...
                    <a href={downloadUrl!} download={`Desbloqueado_${file.name}`} className="w-full bg-[#2980f2] text-white text-center font-bold py-5 rounded-2xl text-xl hover:bg-[#2980f2]/90 shadow-xl flex items-center justify-center mb-4 transition-transform hover:-translate-y-1">
