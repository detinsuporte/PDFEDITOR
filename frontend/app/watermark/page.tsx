    ...
    return (
        <div className="min-h-screen bg-transparent dark:bg-transparent flex flex-col pt-24 pb-12 px-4 items-center font-sans tracking-tight transition-colors">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#33333B] dark:text-gray-100 mb-3 flex items-center gap-3">
                <Stamp className="w-10 h-10 text-[#2980f2]" /> Marca D'Água Global
            </h1>
            ...
            {!file ? (
                ...
                <div className="flex flex-col lg:flex-row gap-8 w-full max-w-5xl items-start justify-center animate-in fade-in zoom-in-95">
                    ...
                    <div className="bg-white dark:bg-[#1e1e1e] p-8 rounded-[30px] shadow-2xl border border-gray-100 dark:border-gray-800 w-full lg:w-1/3 flex flex-col">
                        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-6 flex items-center gap-2">
                            <Stamp className="w-6 h-6 text-[#2980f2]" /> Configurar Carimbo
                        </h3>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full py-3 px-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#121212] text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#2980f2]"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full accent-[#2980f2]"
                                />
                        ...
                        <button onClick={handleProcess} className="w-full mt-8 flex items-center justify-center gap-2 bg-[#2980f2] hover:bg-[#2980f2]/90 text-white font-bold py-4 rounded-xl shadow-lg transition-transform transform hover:-translate-y-1">
                    ...
                    <div className="bg-white dark:bg-[#1e1e1e] p-10 rounded-[30px] shadow-2xl border border-gray-100 dark:border-gray-800 w-full lg:w-2/3 flex flex-col items-center justify-center text-center">
                        <div className="w-20 h-20 bg-[#2980f2]/5 dark:bg-[#2980f2]/10 rounded-full flex items-center justify-center mb-6">
                            <Stamp className="w-10 h-10 text-[#2980f2]" />
                        </div>
                        ...
                        {status === "error" && (
                            <div className="text-[#2980f2] w-full p-4 bg-[#2980f2]/5 dark:bg-[#2980f2]/10 rounded-xl font-medium">Houve um erro no servidor ao processar o Documento.</div>
                        )}
                    </div>
                </div>
            ) : status === "uploading" ? (
                ...
                <div className="flex flex-col items-center mt-10 p-12 bg-white dark:bg-[#1e1e1e] rounded-[40px] shadow-2xl border animate-in slide-in-from-bottom-5">
                    ...
                    <a href={downloadUrl!} download={`Carimbado_${file.name}`} className="w-full bg-[#2980f2] text-white text-center font-bold py-5 rounded-2xl text-xl hover:bg-[#2980f2]/90 shadow-xl flex items-center justify-center mb-4 transition-transform hover:-translate-y-1">
